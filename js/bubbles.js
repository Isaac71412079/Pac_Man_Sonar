...
const BUBBLES_X_START = 30;
const BUBBLES_X_END = 518;
const BUBBLES_GAP = ((BUBBLES_X_END - BUBBLES_X_START) / 25);
const BUBBLES_Y_START = 26;
const BUBBLES_Y_END = 522;
const BUBBLES_SIZE = 3;
let BUBBLES_COUNTER = 0;

let SUPER_BUBBLES = [];
const SUPER_BUBBLES_SIZE = 8;
let SUPER_BUBBLES_BLINK = false;
let SUPER_BUBBLES_BLINK_STATE = 0;
let SUPER_BUBBLES_BLINK_TIMER = -1;
const SUPER_BUBBLES_BLINK_SPEED = 525;
...
function drawBubbles() { 
	...
	const ctx = getBubblesCanevasContext();
...
function isSuperBubble(line, bubble) { 
	return (line === 23 || line === 4) && (bubble === 1 || bubble === 26);
}
