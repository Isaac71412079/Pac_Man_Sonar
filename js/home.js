...
const PACMAN_TRAILER_MOUNTH_STATE_MAX = 6;
const PACMAN_TRAILER_SIZE = 16;

let GHOST_TRAILER_CANVAS_CONTEXT = null;
const GHOST_TRAILER_BODY_STATE_MAX = 6;
const GHOST_TRAILER_POSITION_STEP = 3;

let GHOST_BLINKY_TRAILER_POSITION_X = 1000;
let GHOST_BLINKY_TRAILER_POSITION_Y = 25;
let GHOST_BLINKY_TRAILER_DIRECTION = 3;
const GHOST_BLINKY_TRAILER_COLOR = "#ed1b24";
...
const GHOST_PINKY_TRAILER_COLOR = "#feaec9";
...
const GHOST_INKY_TRAILER_COLOR = "#4adecb";
...
const GHOST_CLYDE_TRAILER_COLOR = "#f99c00";
